  ...
  const aboutContents = [
    {
      ...
      icon: <UsersRound size={170} color="#C7A700" strokeWidth={1.5} />,
    },
    {
      title: "Conexão",
      content:
      ...
      icon: <Earth size={170} color="#C7A700" strokeWidth={1.5} />,
    },
    {
      title: "Cooperação",
      content:
      ...
      icon: <HeartHandshake size={170} color="#C7A700" strokeWidth={1.5} />,
    },
    {
      title: "Solidariedade",
      content:
      ...
      icon: <HandHeart size={170} color="#C7A700" strokeWidth={1.5} />,
    },
  ];
